...
pact -a 01-system.yaml | curl -d @- http://localhost:8080/api/v1/send
...
pact -a 02-accounts.yaml | curl -d @- http://localhost:8080/api/v1/send
...
pact -a 03-create.yaml | curl -d @- http://localhost:8080/api/v1/send
...
pact -a 04-alice.yaml | curl -d @- http://localhost:8080/api/v1/send
...
pact -l -a 05-bob.yaml | curl -d @- http://localhost:8080/api/v1/local
echo ""
